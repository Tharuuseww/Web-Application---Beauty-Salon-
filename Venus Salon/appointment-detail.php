            ...
            <div class="about-inner contact ">
                <div class="container">
                    <div class="main-titles-head text-center">
                        ...
                        <p class="tiltle-para ">"Get ready to captivate with Venus Salon's appointment booking system! Unleash your allure with just a click. Book your glam session now and let your beauty shine brighter than the stars"</p>
                    </div>
                </div>
            </div>
                                ...
                                while ($row = mysqli_fetch_array($ret)) {
                                    ...
                                    <div style="text-align:center;">
                                        ...
                                        <form action="cancel_appointment.php" method="post">
                                            <input type="hidden" name="apt_number" value="<?php echo $row['AptNumber']; ?>">
